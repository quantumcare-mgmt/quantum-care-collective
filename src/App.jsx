               ...
               <div className="text-center py-6 animate-in fade-in zoom-in duration-500">
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <input type="tel" value={phone} onChange={handlePhoneChange} required className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-4 text-slate-900 focus:outline-none focus:border-sky-500 focus:ring-4 focus:ring-sky-500/10 transition-all font-medium" placeholder="(555) 000-0000" />
                        </div>
                    </div>
